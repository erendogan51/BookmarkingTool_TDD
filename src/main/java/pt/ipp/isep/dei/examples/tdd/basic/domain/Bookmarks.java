...
public class Bookmarks {
	...
	public void backupToJSON(String path) throws IOException {
	...
	public void restoreBookmarksFromFile(String path) throws IOException {
		if (path == null || path.equals("")) throw new IllegalArgumentException("specify a path");
		...
		List<Bookmark> bookmarkList =
				new Gson()
						.fromJson
								(reader, new TypeToken<List<Bookmark>>()
								{}.getType());
